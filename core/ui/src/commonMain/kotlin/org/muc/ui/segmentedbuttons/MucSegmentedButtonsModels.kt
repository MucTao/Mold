 ...
 *
 * Размеры синхронизированы с [com.adbdeck.core.ui.splitbuttons.MucSplitButtonSize],
 * чтобы элементы управления выглядели единообразно.
 */
enum class MucSegmentedButtonSize(
    val height: Dp,
 ...
 */
@Immutable
data class MucSegmentedOption<T>(
    val value: T,
    val label: String,
 ...
 */
@Immutable
data class MucSegmentedButtonColors(
 ...
 */
object MucSegmentedButtonDefaults {
    /**
    ...
    ): MucSegmentedButtonColors {
        return MucSegmentedButtonColors(
