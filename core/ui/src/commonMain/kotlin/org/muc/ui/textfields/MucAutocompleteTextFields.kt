 ...
 */
@Composable
fun <T> MucFilledAutocompleteTextField(
    value: String,
    onValueChange: (String) -> Unit,
    suggestions: List<MucDropdownOption<T>>,
 ...
 */
@Composable
fun <T> MucOutlinedAutocompleteTextField(
    value: String,
    onValueChange: (String) -> Unit,
    suggestions: List<MucDropdownOption<T>>,
    onSuggestionSelected: (T) -> Unit,
 ...
 */
@Composable
fun <T> MucPlainAutocompleteTextField(
    value: String,
    onValueChange: (String) -> Unit,
    suggestions: List<MucDropdownOption<T>>,
    onSuggestionSelected: (T) -> Unit,
...
@Composable
private fun <T> MucBaseAutocompleteTextField(
