...
fun MucImage(
    ...
    SubcomposeAsyncImage(
        ...
        loading = {
            LoadingView("图片加载中", Modifier.fillMaxSize().background(MucTheme.colorScheme.surfaceVariant))
        },
...
private fun ErrorPlaceholder(targetModifier: Modifier, icon: ImageVector = Icons.Outlined.Image, throwable: Throwable?) {
    Column(
        modifier = targetModifier.background(MucTheme.colorScheme.surfaceVariant),
