...
import com.adbdeck.core.ui.splitbuttons.MoldSplitButtonColors
import com.adbdeck.core.ui.splitbuttons.MoldSplitButtonDefaults
import com.adbdeck.core.ui.splitbuttons.MoldSplitButtonSize
import com.adbdeck.core.ui.splitbuttons.MoldSplitMenuItem
...
fun <T> MoldSplitButton(
    ...
    colors: MoldSplitButtonColors = MoldSplitButtonDefaults.colors(),
) {
...
private fun SplitPrimaryPart(
    text: String,
    enabled: Boolean,
    size: MoldSplitButtonSize,
    colors: MoldSplitButtonColors,
    shape: Shape,
    onClick: () -> Unit,
) {
...
@Composable
private fun splitTextStyle(size: MoldSplitButtonSize): TextStyle {
    return when (size) {
        MoldSplitButtonSize.LARGE -> MaterialTheme.typography.labelLarge
        MoldSplitButtonSize.MEDIUM -> MaterialTheme.typography.labelMedium
        MoldSplitButtonSize.SMALL -> MaterialTheme.typography.labelSmall
        MoldSplitButtonSize.XSMALL -> MaterialTheme.typography.labelSmall.copy(fontSize = 10.sp)
    }
}
        ...
        Surface(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                MoldSplitButton(
                    ...
                    onPrimaryClick = {},
                    menuItems = listOf(
                        MoldSplitMenuItem("all", "All"),
                        MoldSplitMenuItem("v", "Verbose"),
                        MoldSplitMenuItem("d", "Debug"),
                        MoldSplitMenuItem("i", "Info"),
                        MoldSplitMenuItem("w", "Warning"),
                        MoldSplitMenuItem("e", "Error"),
                    ),
                    selectedMenuValue = "all",
                    onMenuItemClick = {},
                    size = MoldSplitButtonSize.LARGE,
                ...
                MoldSplitButton(
                    ...
                    onPrimaryClick = {},
                    menuItems = listOf(
                        MoldSplitMenuItem("compact", "Compact"),
                        MoldSplitMenuItem("full", "Full"),
                    ),
                    selectedMenuValue = "compact",
                    onMenuItemClick = {},
                    size = MoldSplitButtonSize.MEDIUM,
                ...
                MoldSplitButton(
                    ...
                    selectedMenuValue = "w",
                    onMenuItemClick = {},
                    size = MoldSplitButtonSize.SMALL,
                ...
                MoldSplitButton(
                    ...
                    selectedMenuValue = "e",
                    onMenuItemClick = {},
                    size = MoldSplitButtonSize.XSMALL,
