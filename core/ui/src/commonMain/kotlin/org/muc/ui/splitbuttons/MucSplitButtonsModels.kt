 ...
 */
@Immutable
data class MucSplitButtonColors(
...
object MucSplitButtonDefaults {
    ...
    ): MucSplitButtonColors {
        return MucSplitButtonColors(
